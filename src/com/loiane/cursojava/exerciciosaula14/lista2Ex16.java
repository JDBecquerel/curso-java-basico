...
public class lista2Ex16 {
	...
	public static void main(String[] args) {
		...
		System.out.println("PROGRAMA PARA CALCULAR VALORES DAS RAÍZES DA EQUAÇÃO \n\n\n"
		...
		if(a != 0){
			...
			if(delta < 0){
				...
				double r = -b/2*a;
				System.out.println("A equação possui somente uma raíz real: " + r);
				...
				System.out.println("A equação possui raízes e são, r1: " + r1 + " e r2: " + r2);
			}
		}
